...
import { createBookingAndPayment } from '@/app/actions';
...
export default function BookingClient({ providerId, serviceName }: BookingClientProps) {
    ...
    const handleBooking = async () => {
        ...
        try {
            const result = await createBookingAndPayment({
                providerId: providerId, // Pass providerId to Server Action
                userId: profile.userId,
    ...
    return (
        <main className="min-h-screen bg-slate-50 pb-20">
            ...
            <header className="bg-purple-900 text-white p-4 shadow-md sticky top-0 z-10">
                <h1 className="text-xl font-bold text-center">{serviceName} 予約</h1>
            </header>
